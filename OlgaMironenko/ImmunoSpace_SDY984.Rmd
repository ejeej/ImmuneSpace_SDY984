...
Всего для `r nrow(genes_sig_ame7)` ATE в 7 дней был значим в модели с исходными данными по экспрессии или с рангами по экспрессии, но не значим ни в одной из них в 0-3 дня. Ниже представлены биологические процессы, в которых участвуют продукты этих генов (с количеством генов из указанного числа, 5 и более).
...
```{r fig8_bps_change, fig.width=9, fig.height=6}
gobp_time <- bind_rows(
...
```{r fig9_bps_change_imm, fig.width=9, fig.height=5}
gobp_time_plot <- gobp_time %>%
...
```{r fig10_upset_logreg, fig.width=10, fig.height=5}
# Whether each gene was significant in any model
genes_maxvar <- cbind(
  genes_maxvar,
...
```{r fig11_compmodels, fig.width=7, fig.height=8}
upset_plt_df_1 <- genes_maxvar %>%
...
```{r fig12_volcano_or, fig.width=6, fig.height=12}
