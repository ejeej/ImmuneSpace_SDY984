...
We can list genes with the largest positive log(OR), i.e. with expression strongly positively related to the probability of the high immune response: _STX3, IL2RA, RIC3, TREML5P, IRGQ, CROCCP2, SYNGAP1_, and genes with the largest negative log(OR), i.e. i.e. with expression strongly negatively related to the probability of the high immune response: _CCL5, SNX33, RAP2A_.
